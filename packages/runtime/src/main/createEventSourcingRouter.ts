...
//
//   registerAggregate<A extends IAggregateAgent<unknown, Handler>, Handler extends IAggregateHandler>(aggregate: A, handler: Handler): void;
//
//   registerProcessManager<P extends IProcessManagerAgent<unknown, Handler>, Handler extends IAggregateHandler>(aggregate: P, handler: Handler): void;
//
//   registerEventListener<P extends IEventListenerAgent<Handler>, Handler>(processManager: P, handler: Handler): void;
//
...
//
//   const aggregateMap = new Map<IAggregateAgent, IAggregateHandler>();
//   const processManagerMap = new Map<IProcessManagerAgent, IAggregateHandler>();
//   const eventListenerMap = new Map<IEventListenerAgent, unknown>();
//
//   return {
//
//     async handleCommand(command) {
//       let aggregate: IAggregateAgent | undefined;
